...
__name(_NullValidationHandler, "NullValidationHandler");
var NullValidationHandler = _NullValidationHandler;
var _OAuthModuleConfig = class _OAuthModuleConfig {
};
__name(_OAuthModuleConfig, "OAuthModuleConfig");
var OAuthModuleConfig = _OAuthModuleConfig;
var _OAuthResourceServerConfig = class _OAuthResourceServerConfig {
};
__name(_OAuthResourceServerConfig, "OAuthResourceServerConfig");
var OAuthResourceServerConfig = _OAuthResourceServerConfig;
var _DateTimeProvider = class _DateTimeProvider {
};
__name(_DateTimeProvider, "DateTimeProvider");
var DateTimeProvider = _DateTimeProvider;
...
__name(_SystemDateTimeProvider, "SystemDateTimeProvider");
_SystemDateTimeProvider.ɵfac = /* @__PURE__ */ (() => {
  let ɵSystemDateTimeProvider_BaseFactory;
  return /* @__PURE__ */ __name(function SystemDateTimeProvider_Factory(__ngFactoryType__) {
  ...
  }, "SystemDateTimeProvider_Factory");
})();
...
var _LoginOptions = class _LoginOptions {
  constructor() {
    this.disableNonceCheck = false;
    this.preventClearHashAfterLogin = false;
  }
};
__name(_LoginOptions, "LoginOptions");
var LoginOptions = _LoginOptions;
var _OAuthLogger = class _OAuthLogger {
};
__name(_OAuthLogger, "OAuthLogger");
var OAuthLogger = _OAuthLogger;
var _OAuthStorage = class _OAuthStorage {
};
__name(_OAuthStorage, "OAuthStorage");
var OAuthStorage = _OAuthStorage;
...
_MemoryStorage.ɵfac = /* @__PURE__ */ __name(function MemoryStorage_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MemoryStorage)();
}, "MemoryStorage_Factory");
...
var _ReceivedTokens = class _ReceivedTokens {
};
__name(_ReceivedTokens, "ReceivedTokens");
var ReceivedTokens = _ReceivedTokens;
var _OAuthEvent = class _OAuthEvent {
  constructor(type) {
    this.type = type;
  }
};
__name(_OAuthEvent, "OAuthEvent");
var OAuthEvent = _OAuthEvent;
var _OAuthSuccessEvent = class _OAuthSuccessEvent extends OAuthEvent {
  constructor(type, info = null) {
    super(type);
    this.info = info;
  }
};
__name(_OAuthSuccessEvent, "OAuthSuccessEvent");
var OAuthSuccessEvent = _OAuthSuccessEvent;
var _OAuthInfoEvent = class _OAuthInfoEvent extends OAuthEvent {
  constructor(type, info = null) {
    super(type);
    this.info = info;
  }
};
__name(_OAuthInfoEvent, "OAuthInfoEvent");
var OAuthInfoEvent = _OAuthInfoEvent;
var _OAuthErrorEvent = class _OAuthErrorEvent extends OAuthEvent {
...
__name(_OAuthErrorEvent, "OAuthErrorEvent");
var OAuthErrorEvent = _OAuthErrorEvent;
...
var _AuthConfig = class _AuthConfig {
  constructor(json) {
    this.clientId = "";
    this.redirectUri = "";
...
__name(_AuthConfig, "AuthConfig");
var AuthConfig = _AuthConfig;
var _WebHttpUrlEncodingCodec = class _WebHttpUrlEncodingCodec {
  encodeKey(k) {
...
__name(_WebHttpUrlEncodingCodec, "WebHttpUrlEncodingCodec");
var WebHttpUrlEncodingCodec = _WebHttpUrlEncodingCodec;
var _ValidationHandler = class _ValidationHandler {
};
__name(_ValidationHandler, "ValidationHandler");
var ValidationHandler = _ValidationHandler;
var _AbstractValidationHandler = class _AbstractValidationHandler {
  /**
...
__name(_AbstractValidationHandler, "AbstractValidationHandler");
var AbstractValidationHandler = _AbstractValidationHandler;
...
__name(_UrlHelperService, "UrlHelperService");
_UrlHelperService.ɵfac = /* @__PURE__ */ __name(function UrlHelperService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _UrlHelperService)();
}, "UrlHelperService_Factory");
...
var _HashHandler = class _HashHandler {
};
__name(_HashHandler, "HashHandler");
var HashHandler = _HashHandler;
...
__name(_DefaultHashHandler, "DefaultHashHandler");
_DefaultHashHandler.ɵfac = /* @__PURE__ */ __name(function DefaultHashHandler_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _DefaultHashHandler)();
}, "DefaultHashHandler_Factory");
...
var _OAuthService = class _OAuthService extends AuthConfig {
  ...
  initLoginFlowInPopup(options) {
    ...
    return this.createLoginUrl(null, null, this.silentRefreshRedirectUri, false, {
      ...
      return new Promise((resolve, reject) => {
        ...
        const tryLogin = /* @__PURE__ */ __name((hash2) => {
          this.tryLogin({
        ...
        const checkForPopupClosed = /* @__PURE__ */ __name(() => {
        ...
        const storageListener = /* @__PURE__ */ __name((event) => {
  ...
  processIdToken(idToken, accessToken, skipNonceCheck = false) {
    ...
    const validationParams = {
      ...
      loadKeys: /* @__PURE__ */ __name(() => this.loadJwks(), "loadKeys")
    };
...
__name(_OAuthService, "OAuthService");
_OAuthService.ɵfac = /* @__PURE__ */ __name(function OAuthService_Factory(__ngFactoryType__) {
...
var _OAuthResourceServerErrorHandler = class _OAuthResourceServerErrorHandler {
};
__name(_OAuthResourceServerErrorHandler, "OAuthResourceServerErrorHandler");
var OAuthResourceServerErrorHandler = _OAuthResourceServerErrorHandler;
var _OAuthNoopResourceServerErrorHandler = class _OAuthNoopResourceServerErrorHandler {
  handleError(err2) {
    return throwError(err2);
  }
};
__name(_OAuthNoopResourceServerErrorHandler, "OAuthNoopResourceServerErrorHandler");
var OAuthNoopResourceServerErrorHandler = _OAuthNoopResourceServerErrorHandler;
...
__name(_DefaultOAuthInterceptor, "DefaultOAuthInterceptor");
_DefaultOAuthInterceptor.ɵfac = /* @__PURE__ */ __name(function DefaultOAuthInterceptor_Factory(__ngFactoryType__) {
...
}, "DefaultOAuthInterceptor_Factory");
...
__name(createDefaultStorage, "createDefaultStorage");
...
__name(provideOAuthClient, "provideOAuthClient");
...
__name(_OAuthModule, "OAuthModule");
_OAuthModule.ɵfac = /* @__PURE__ */ __name(function OAuthModule_Factory(__ngFactoryType__) {
...
`;
var _JwksValidationHandler = class _JwksValidationHandler extends NullValidationHandler {
  constructor() {
    super();
    console.error(err);
  }
};
__name(_JwksValidationHandler, "JwksValidationHandler");
var JwksValidationHandler = _JwksValidationHandler;
